 ...
 * @author stbachmann
 * @author Nathan Sweet */
public class ShapeRenderer3D implements Disposable {
	...
	public ShapeRenderer3D () {
		this(5000);
	}

	public ShapeRenderer3D (int maxVertices) {
	...
	public void triangle (float x1, float y1, float x2, float y2, float x3, float y3) {
		...
		if (shapeType == ShapeType.Line) {
			renderer.color(color);
			renderer.vertex(x1, 0, y1);
			renderer.color(color);
			renderer.vertex(x2, 0, y2);

			renderer.color(color);
			renderer.vertex(x2, 0, y2);
			renderer.color(color);
			renderer.vertex(x3, 0, y3);
	...
	public void rectLine (float x1, float y1, float x2, float y2, float width) {
		...
		if (shapeType == ShapeType.Line) {
			renderer.color(color);
			renderer.vertex(x1 + tx, 0, y1 + ty);
			renderer.color(color);
			renderer.vertex(x1 - tx, 0, y1 - ty);

			renderer.color(color);
			renderer.vertex(x2 + tx, 0, y2 + ty);
			renderer.color(color);
			renderer.vertex(x2 - tx, 0, y2 - ty);
